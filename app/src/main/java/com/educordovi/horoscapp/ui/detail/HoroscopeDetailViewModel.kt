package com.educordovi.horoscapp.ui.detail

import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import com.educordovi.horoscapp.domain.model.HoroscopeModel
import com.educordovi.horoscapp.domain.usecase.GetPredictionUseCase
...
class HoroscopeDetailViewModel @Inject constructor(private val getPredictionUseCase: GetPredictionUseCase): ViewModel() {
    ...
    fun getHoroscope(sign: HoroscopeModel){
        ...
        viewModelScope.launch {
            ...
            val result = withContext(Dispatchers.IO){getPredictionUseCase(sign.name)}//hilo sedundario
            //hilo principal
            if (result!=null){
